...
| v0.5 | Component-model coverage. Post-cfg, post-meld, post-loom measurement points. Variant-aware scope. | How does witness interact with loom's translation-validation output? Does walrus support components, or do we need wasm-tools / Whamm? |
